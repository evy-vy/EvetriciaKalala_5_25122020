...
function displayCameraById(camera) {
  ...
  */
  ...
  //Ajout des articles aux paniers et définition des fonctionnalitées enclanchée au clic
  let addToCart = btn;
  addToCart.addEventListener("click", () => {
    ...
    if (localStorageElt === null) {
      ...
      //permet d"afficher le nombre d"aricle ajouté au panier au niveau de la barre de navigation grace au nombre d'éléments comptés dans le localStorage.
